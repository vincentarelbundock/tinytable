...
block[ // start block
 ...
 table.hline(y: 2, start: 0, end: 8, stroke: 0.05em),
 table.hline(y: 14, start: 0, end: 8, stroke: 0.08em),
 table.hline(y: 0, start: 0, end: 8, stroke: 0.08em),
    // tinytable lines before

    // tinytable header start
    table.header(
      repeat: true,
table.cell(colspan: 3, align: center)[Hamburgers #place(bottom, dy: 0.4em, line(length: 100%, stroke: 0.03em))], table.cell(colspan: 2, align: center)[Halloumi #place(bottom, dy: 0.4em, line(length: 100%, stroke: 0.03em))], [ ], [Tofu #place(bottom, dy: 0.4em, line(length: 100%, stroke: 0.03em))], [ ],
