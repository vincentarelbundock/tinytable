...
block[ // start block
 ...
 table.hline(y: 11, start: 0, end: 8, stroke: 0.08em + black),
 table.hline(y: 0, start: 0, end: 8, stroke: 0.08em + black),
    // tinytable lines before

    // tinytable header start
    table.header(
      repeat: true,
table.cell(colspan: 3, align: center)[Hamburgers #place(bottom, dy: 0.4em, line(length: 100%, stroke: 0.03em + black))], table.cell(colspan: 2, align: center)[Halloumi #place(bottom, dy: 0.4em, line(length: 100%, stroke: 0.03em + black))], [ ], [Tofu #place(bottom, dy: 0.4em, line(length: 100%, stroke: 0.03em + black))], [ ],
