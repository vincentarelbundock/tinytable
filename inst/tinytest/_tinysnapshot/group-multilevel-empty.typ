...
block[ // start block
  ...
  #let style-dict = (
    ...
    "1_0": 0, "0_0": 0, "1_1": 0, "0_1": 0, "1_2": 0, "0_2": 0, "1_3": 0, "0_3": 0
  )
 ...
 table.hline(y: 2, start: 3, end: 4, stroke: 0.05em + black),
 ...
 table.hline(y: 0, start: 0, end: 4, stroke: 0.1em + black),
    ...
    table.header(
      repeat: true,
table.cell(stroke: (bottom: .05em + black), colspan: 3, align: center)[A],[ ],
[ ],table.cell(stroke: (bottom: .05em + black), colspan: 2, align: center)[B],table.cell(stroke: (bottom: .05em + black), colspan: 1, align: center)[D],
[C], [C], [B], [E],
    ),
