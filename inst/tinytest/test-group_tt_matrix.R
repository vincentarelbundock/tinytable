...
t <- expect_table(tab)
expect_snapshot_print(t[["markdown"]], "group_tt_matrix-single_position_single_row.md")
expect_snapshot_print(t[["latex"]], "group_tt_matrix-single_position_single_row.tex")
expect_snapshot_print(t[["typst"]], "group_tt_matrix-single_position_single_row.typ")
expect_snapshot_print(t[["html"]], "group_tt_matrix-single_position_single_row.html")
...
t <- expect_table(tab)
expect_snapshot_print(t[["markdown"]], "group_tt_matrix-multiple_positions_multiple_rows.md")
expect_snapshot_print(t[["latex"]], "group_tt_matrix-multiple_positions_multiple_rows.tex")
expect_snapshot_print(t[["typst"]], "group_tt_matrix-multiple_positions_multiple_rows.typ")
...
t <- expect_table(tab)
expect_snapshot_print(t[["markdown"]], "group_tt_matrix-single_column_with_styling.md")
