...
# Customization: HTML with `Bootstrap`

```{r, include=FALSE}
knitr::opts_chunk$set(eval = knitr::is_html_output())
```
...
# Customization: LaTeX with `tabularray`

```{r, include=FALSE}
knitr::opts_chunk$set(eval = knitr::is_latex_output())
```
