...
tt(dat) |>
  plot_tt(j = 2, plot_fun = "histogram", plot_data = plot_data) |>
  plot_tt(j = 3, plot_fun = "density", plot_data = plot_data, color = "darkgreen") |>
  plot_tt(j = 4, plot_fun = "bar", plot_data = list(2, 3, 6), color = "lightblue") |>
