...
`tinytable` offers a few basic themes out of the box: "default", "striped", "bootstrap", "grid", "void." Those themes can be applied with the `theme` argument of the `tt()` function, or with the `theme_tt()` function.
