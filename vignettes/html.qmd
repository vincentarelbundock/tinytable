...
## JS Plotting Libraries: Plotly, D3, etc.

[Plotly](https://plotly.com/javascript/) is a popular JavaScript library for creating interactive charts and visualizations. We can embed Plotly plots directly in `tinytable` HTML tables by combining two features:
