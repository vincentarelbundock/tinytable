...
```{r}
df <- structure(list(Col1 = c("Col Header", "Item 0", "Item 1", "Item 2", "Total"), Col2 = c("Span 1", "X", "xx", "xx", "xxxx"), Col2.1 = c("Span 1", "Y", "xx", "xx", "xxxx"), Col2.2 = c("Span 2", "X", "xx", "xx", "xxxx"), Col2.3 = c("Span 2", "Y", "xx", "xx", "xxxx")), class = "data.frame", row.names = c(NA, -5L))
df |>
    setNames(NULL) |>
    tt() |>
