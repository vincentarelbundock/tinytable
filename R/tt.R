...
#'
#' The table object has S4 slots which hold information about the structure of the table. For example, the `table@index_group_i` slot includes the row indices for grouping labels added by `group_tt()`.
#'
