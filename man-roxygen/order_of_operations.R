...
#'
#' 1. `group_tt()`: Row and column grouping operations are applied to insert group headers and modify table structure.
#' 2. `format_tt()`: Number and string formatting operations are applied first to ensure all data is properly formatted before any other operations.
